...
2. The necessary files can be found in `smk-exercises`. The snakemake file is located at: `rules/process_1kgp.smk`.
...
- Define inputs and outputs:
  - Input: metadata file ('/work/HPCLab_workshop/pipes/data/samples_EB.tsv')
...
INFILE="/work/HPCLab_workshop/pipes/data/samples_EB.tsv"
OUTPUT="/work/hpcPipes/results_eb/samples_EB_cleaned.tsv"
...
rule step1_preprocess:
    input: /work/HPCLab_workshop/pipes/data/samples_EB.tsv
    ...
    resources: tmpdir=<TBD>
        ...
        python scripts/preprocess.py /work/HPCLab_workshop/pipes/data/samples_EB.tsv results/samples_EB_cleaned.tsv
