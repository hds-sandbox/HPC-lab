...
- `hpcPipes`: from your personal drive. Save your results/files here.  
...
2. The necessary files can be found in `hpcPipes`. The snakemake file is located at: `rules/process_1kgp.smk`.
...
You will be working and running the workflow from `hpcPipes`, so make sure it's set as your working directory.

##### Preparation step 

- **Directory setup**: Inside `hpcPipes`, create two subdirectories, `scripts` and `rules`. 
