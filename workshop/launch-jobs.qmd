...
1. Create a new subdirectory called batchLaunch inside your hpcLaunch/Day2 folder and move (`cd`) into it:
...
2. Download the Input Data (FASTQ files)
...
6. Monitor the Job (check the status)
