...
2. The necessary files can be found in `smk-exercises`. The snakemake file is located at: `hpcPipes/rules/process_1kgp.smk`.
...
- File paths for UCloud users: 
  ...
  - Input PLINK files: `/work/HPCLab_workshop/pipes/data/plink_sim/sim.small.*`
...
PLINKPATH: "/work/HPCLab_workshop/pipes/data/plink_sim"
FPREFIX: "sim.small"
...
SEEDS:
  ...
  - 2
  - 3    # Seed values
PATH_SCRIPT: "/work/HPCLab_workshop/pipes/scripts"
```
