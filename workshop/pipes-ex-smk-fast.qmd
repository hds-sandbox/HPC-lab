...
- `hpcPipes`: from your personal drive.
...
Finally, navigate to your WD, `hpcPipes`, and to create a new subdirectory `fastmixture` and save here all files from this exercise (Snakefile, config.yml, output file, etc.).
