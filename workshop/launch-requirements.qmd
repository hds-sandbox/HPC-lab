...
A Danish university/institution account is required to create a UCloud account. If you don't have one, click on *Local setup* below. However, you will need access to be able to submit SLURM job scripts (a cluster management and job scheduling system). 
:::
