...
![](./images/terminalResources.png){width="800" height="150"}
...
![](./images/addFolder.png){width="800" height="150"}
...
12. Print the last command in `greetings.txt`.  Use `head` or `awk`.
...
:::{.callout-hint}
Here are some of the commands you need (random order):
