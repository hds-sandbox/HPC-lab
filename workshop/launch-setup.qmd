...
![](./images/terminalResources.png){width="750" height="250"}
...
![](./images/addFolder.png){width="700" height="225"}

6. Scroll down and remember to click on  *Enable SSH access*. 
![](./images/enableSSH.png){width="750" height="200"}
...
![](./images/sshCommand.png){width="900"}

For example: `ssh ucloud@ssh.cloud.sdu.dk -p 2396` 
