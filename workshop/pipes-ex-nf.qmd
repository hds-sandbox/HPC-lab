...
2. Remember to get an interactive session in SLURM and do not run any nextflow command on the login node. 
```.bash
srun --account DeiC-KU-L65 -t 00:00:30 --pty bash
```
3. `exit` the interactive job when you are done with the exercise! 
