...
![Figure: A package's dependency tree with required versions on the edges](images/condatree.png){fig-align="center" width="800px"}

---

To install a specific package in your environment, search for it on [anaconda.org](https://anaconda.org):

![](images/anaconda1.png){fig-align="center" width="800px"}
